                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/cabinet/${cabinet.getId()}/update"  method="post">
                                <div class="login__header text-center mb-lg-5 mb-4">
                                    <h3 class="login__title mb-2">Cabinet</h3>
                                    <p>Update, and continue</p>

                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="input__label">Name</label>
                                    <input type="text" name="nameCabinet" class="form-control login_text_field_bg input-style" id="exampleInputEmail1" aria-describedby="emailHelp" value="${cabinet.getName()}" placeholder="Name" readonly autofocus="">
                                </div>
                                <div class="form-group">
                                    <select name="nameBranch" class="form-control login_text_field_bg input-style">
                                        <#list branches as branch>
                                            <option class="form-control login_text_field_bg input-style" value="${branch.getName()}"
                                ...
                                <div class="form-group">
                                    <#list cabinet.getCabinetEmployee() as cabInfo>
                                        <div class="row justify-content-center">
                                            <div class="col-5"><p> ${cabInfo.getDay().getDay()}</p></div>
                                            <div class="col-5">
                                                <select name="${cabInfo.getDay()}" class="form-control login_text_field_bg input-style" >
                                                    <option class="form-control login_text_field_bg input-style"  value="empty" selected>Никого</option>
                                                    <#list employees as employee>
                                                        <option class="form-control login_text_field_bg input-style"  value="${employee.getUsername()}"
