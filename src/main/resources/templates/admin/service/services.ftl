                ...
                <div class="row">
                    <div class="col-lg-12 mb-4">
                        <div class="card card_border p-4">
                            <h3 class="card__title position-absolute">Services</h3>
                            <div class="table-responsive">
                                <div id="example_wrapper_2" class="dataTables_wrapper no-footer"><div class="dataTables_length" id="example_length_1"><label></label></div><table id="example_1" class="display dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="example_info">
                                        ...
                                        <tr role="row" style = "background-color: var(--light-bg-color);">
                                            <th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Emp. Name: activate to sort column descending" style="width: 296px;">Name</th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Designation: activate to sort column ascending" style="width: 456px;">Price</th>
                                        ...
                                        <#list services as service>
                                            <tr role="row" class="odd"  style = "border-bottom: 2px solid #E7EDF6;">
                                                <td class="sorting_1" style = "padding: 8px 10px;" text="${service.getName()}">${service.getName()}</td>
                                                <td style = "padding: 8px 10px;" text="${service.getPrice()}">${service.getPrice()}</td>
                                                <td style = "padding: 8px 10px;"><a href="/admin/service/${service.getId()}"   class="badge badge-success">View</a><a href="/admin/service/${service.getId()}/delete" class="badge badge-danger">Delete</a></td>
                                            </tr>
                                        </#list>
                                        </tbody>
                                    </table>
                    ...
                    <div class="card-body">
                        <form action="/admin/service/add" method="post">
                            <div class="login__header text-center mb-lg-5 mb-4">
                                <h3 class="login__title mb-2"> Add Service</h3>
                            ...
                            <label for="exampleInputEmail1" class="input__label">Price</label>
                            <input type="text" class="form-control login_text_field_bg input-style" name="price" placeholder="Price">
