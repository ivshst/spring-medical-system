                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/service/${service.getId()}/update"  method="post">
                                <div class="login__header text-center mb-lg-5 mb-4">
                                    <h3 class="login__title mb-2">Service</h3>
                                    <p>Update, and continue</p>

                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="input__label">Name</label>
                                    <input type="text" name="name" class="form-control login_text_field_bg input-style" id="exampleInputEmail1" aria-describedby="emailHelp" value="${service.getName()}" placeholder="Name">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="input__label">Price</label>
                                    <input type="text" name="price" class="form-control login_text_field_bg input-style" id="exampleInputEmail1" aria-describedby="emailHelp" value="${service.getPrice()}" placeholder="Price">
                                </div>
